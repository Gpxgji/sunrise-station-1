...
ent-ClothingOuterHardsuitSeniorOfficer = скафандр инструктора СБ
    .desc = Специальный костюм, защищающий от опасной среды с низким давлением. Имеет уникальную конструкцию, выделяющую инструктора среди рядовых сотрудников служб безопасности.
